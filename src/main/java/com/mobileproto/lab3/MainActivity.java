                    ...
                    final String phoneName = ((TelephonyManager) getSystemService(Context.TELEPHONY_SERVICE)).getDeviceId();
                        ...
                        runOnUiThread( new Runnable() {
                            ...
                            public void run() {
                                ...
                                gps_velocity = convert(prevLat, prevLong, curLat,curLong)/(curTime - prevTime)*1000;//Math.sqrt((curLat-prevLat)*(curLat-prevLat)+(curLong-prevLong)*(curLong-prevLong))*6371000.0/((curTime-prevTime)/1000.0);
                                ...
                                if (gps.canGetLocation()){
                                    ...
                                    }else{Toast.makeText(getApplicationContext(), "GPS AIN'T WORKING", Toast.LENGTH_LONG).show();}
